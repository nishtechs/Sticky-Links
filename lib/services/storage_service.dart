...
class StorageService {
  ...
  // Categories
  static Box<CategoryItem> get categoriesBox =>
      Hive.box<CategoryItem>(_categoriesBoxName);
  ...
  static bool get isGridView =>
      settingsBox.get('isGridView', defaultValue: false);
  static Future<void> setGridView(bool value) async =>
      await settingsBox.put('isGridView', value);
  ...
  static int get backupIntervalHours =>
      settingsBox.get('backupIntervalHours', defaultValue: 1);
  static Future<void> setBackupIntervalHours(int value) async =>
      await settingsBox.put('backupIntervalHours', value);
  ...
  static bool get hasShownTutorial =>
      settingsBox.get('hasShownTutorial', defaultValue: false);
  static Future<void> setHasShownTutorial(bool value) async =>
      await settingsBox.put('hasShownTutorial', value);

  static int get themeColorValue =>
      settingsBox.get('themeColorValue', defaultValue: 0xFF6366F1);
  static Future<void> setThemeColorValue(int value) async =>
      await settingsBox.put('themeColorValue', value);

  static bool get isGlassEnabled =>
      settingsBox.get('isGlassEnabled', defaultValue: true);
  static Future<void> setGlassEnabled(bool value) async =>
      await settingsBox.put('isGlassEnabled', value);

  static bool get isDynamicBackgroundEnabled =>
      settingsBox.get('isDynamicBackgroundEnabled', defaultValue: true);
  static Future<void> setDynamicBackgroundEnabled(bool value) async =>
      await settingsBox.put('isDynamicBackgroundEnabled', value);
